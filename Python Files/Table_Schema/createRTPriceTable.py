...
class Ercot_RT_Prices(Base):
    ...
    deliver_hour: Mapped[int] = mapped_column()
    deliver_interval: Mapped[int] = mapped_column()
    repeated_hour_flag: Mapped[bool] = mapped_column()
    settlement_point_name: Mapped[str] = mapped_column(String)
    settlement_point_type: Mapped[str] = mapped_column(String)
